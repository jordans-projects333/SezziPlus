...
const AccountModel = () => {
    ...
    return (
        <motion.div ref={fadedBackground} className={`fixed w-[100%] h-[100lvh] bg-black/50 top-0 ${!accountModelToggle && 'pointer-events-none'} opacity-0`}
                    variants={varients} animate={accountModelToggle ? 'visible' : 'invisible'} onClick={(e) => handleAccountModelToggle(e)}>
            <AnimatePresence mode="wait">
                <motion.div variants={varients} animate={accountModelToggle ? 'active' : 'inactive'} className='accountModel absolute top-[10%] left-[50%] translate-x-[-50%] translate-y-[100vh] pb-8'>
