    ...
    return (
        <nav className='opacity-1'>
            <ul className='flex mx-2 gap-2 text-white overflow-auto font-openSans font-medium'>
                <Link href={'/'}><li className={`${pathname === '/' && 'bg-[#B23928]'} bg-[#424242] px-3 py-[2px] rounded duration-300 flex-shrink-0`}>Messages</li></Link>
                <Link href={'/Notes'}><li className={`${pathname === '/Notes' && 'bg-[#B23928]'} bg-[#424242] px-3 py-[2px] rounded duration-300 flex-shrink-0`}>Notes</li></Link>
